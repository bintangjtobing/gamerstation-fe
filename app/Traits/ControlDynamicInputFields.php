...
trait ControlDynamicInputFields
{
    ...
    //for topup of gameshop
    public function generateValidationRulesForTopup($kyc_fields)
    {
        $validation_rules = [];
    ...
    //for topup of gameshop
    public function placeValueWithFieldsTopUp($kyc_fields, $form_data)
    {
        $fields_with_value = [];
    ...
    {
        $user_kyc = auth()->guard(get_auth_guard())->user()->kyc;
        if ($user_kyc) {
            if ($user_kyc->data) {
