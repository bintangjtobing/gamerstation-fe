                            ...
                            <div class="dash-payment-item active">
                                ...
                                <div class="dash-payment-body">
                                    <div class="faq-wrapper">
                                        ...
                                        <!-- QRIS -->
                                        <div class="faq-item">
                                            <h3 class="faq-title" onclick="toggleContent('qris-content')">
                                        ...
                                        <!-- Virtual Account -->
                                        <div class="faq-item">
                                            <h3 class="faq-title" onclick="toggleContent('va-content')">
        ...
        <div class="modal-content bg-dark text-light" style="border-radius: 10px;">
            <div class="modal-header border-0 d-flex flex-column align-items-center" style="padding-bottom:0;">
                ...
                <h4 class="modal-title text-center" id="successModalLabel" style="font-size: 24px; font-weight: bold;">
                    Verifikasi Pembayaran</h4>
            </div>
            <div class="modal-body text-center" style="padding-top:10px;">
                <p>Tunggu sebentar ya<br>Kami sedang memverifikasi pembayaran Anda...</p>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="successModal" tabindex="-1" aria-labelledby="successModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content bg-dark text-light" style="border-radius: 10px;">
            ...
            <div class="modal-body text-center" style="padding-top:10px;">
                <p>Kamu berhasil membeli 10 koin untuk Clash of Clans.<br>Berikut voucher ID kamu:</p>
                <pre id="voucherId"
...
<script>
    function submitForm() {
        ...
        // Setelah 3 detik, tutup modal verifikasi dan tampilkan modal sukses
        setTimeout(() => {
    ...
    // Fungsi untuk generate voucher ID
