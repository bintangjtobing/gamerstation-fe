        ...
        <div class="account-form-area">
            <div class="account-logo text-start">
                <a href="{{ route('index') }}" class="site-logo">
                    ...
                    <img src="{{asset('fileholder/img/b88efc35-a595-4d50-bc55-857d7a5dc830.png')}}" alt=" logo">
                </a>
            </div>
            <h5 class="title">{{__('Login Information')}}</h5>
            <p>{{__('Please input your email and password and login to your account to get access to your dashboard.')}}
            </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 form-group">
                            <div class="forgot-item">
                                {{-- <label><a href="{{ route('user.password.forgot') }}">{{__('Forgot
                                        Password?')}}</a></label> --}}
        ...
        <div class="account-form-area">
            <div class="account-logo text-start">
                <a class="site-logo" href="{{ route('index') }}"><img
                        src="{{asset('fileholder/img/b88efc35-a595-4d50-bc55-857d7a5dc830.png')}}" alt=" logo"></a>
            </div>
            ...
            {{-- <form action="{{ route('user.register.submit') }}" method="POST" class="account-form"> --}}
                <form action="" method="POST" class="account-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 form-group">
                            <div class="custom-check-group">
                                ...
                                <label for="level-1">{{__('I have agreed with')}} <a
                                        href="{{ url('link/privacy-policy') }}" class="text--base">{{__('Privacy
                                        Policy')}}</a></label>
                            </div>
                        </div>
                        {{-- @endif --}}
                        ...
                        <div class="col-lg-12 text-center">
                            <div class="account-item">
                                <label>{{__('Already Have An Account?')}} <a href="#0"
