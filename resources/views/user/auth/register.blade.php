    ...
    <div class="right float-end">
        ...
        <div class="account-middle">
            <div class="account-form-area">
                ...
                <p>{{ __('Please input your details and register to your account to get access to your dashboard.') }}
                </p>
                    ...
                    <div class="row ml-b-20">
                        ...
                        <div class="col-lg-12 form-group">
                            <div class="custom-check-group mb-0">
                                ...
                                <label for="level-1" class="mb-0">{{ __('I have read agreed with the') }} <a href="#0"
                                        class="text--base">{{ __('Terms Of Use , Privacy Policy & Warning')
                                        }}</a></label>
                            </div>
                            {{-- @error('agree')
                            <span class="invalid-feedback d-block" role="alert">
