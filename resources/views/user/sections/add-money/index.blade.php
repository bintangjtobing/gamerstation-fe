                        ...
                        <div class="dash-payment-body">
                            <form class="card-form" action="{{ setRoute('user.add.money.submit') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 col-lg-12 mt-50 text-center">
                                        <button type="submit" class="btn--base w-75 btn-loading">{{ __('Add Money') }} <i
...
@push('script')
    <script>
        ...
        function getFees() {
            ...
            $(".fees-show").html("{{ __('Charge') }}" + ': ' + parseFloat(charges.fixed).toFixed(2) + " " +
                sender_currency +
                " + " +
