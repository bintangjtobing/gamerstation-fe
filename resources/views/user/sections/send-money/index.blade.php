                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xxl-6 col-xl-12 col-lg-6 form-group paste-wrapper">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="user" class="form--control checkUser"
                                                id="username" placeholder="Enter Mobile Number"
                                                value="{{ old('user') }}" />
                                        </div>
                                        <button type="button" class="paste-badge scan" data-toggle="tooltip"
                                            title="Scan QR"><i class="fas fa-camera"></i></button>
                                    ...
                                    <div class="col-xl-12 col-lg-12">
                                        <button type="submit"
                                            class="btn--base w-100 btn-loading transfer">{{ __('Confirm Send') }} <i
                                                class="fas fa-paper-plane ms-1"></i></i></button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
@push('script')
    ...
    <script>
        ...
        function getFees() {
            ...
            $(".fees-show").html("Transfer Fee: " + parseFloat(charges.fixed).toFixed(2) + " " + currencyCode + " + " +
