                            ...
                            <div class="preview-thumb profile-wallpaper">
                                <div class="avatar-preview">
                                    <div class="profilePicPreview bg_img"
                                        data-background="{{ asset('frontend') }}/images/product-item/5.jpg"
                                        style="background-image: url(&quot;{{ asset('frontend') }}/images/product-item/5.jpg&quot;);">
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <p>{{ __('If you do not think you will use ') }}“<strong>{{ @$basic_settings->site_name }}</strong>”
                    {{ __('again and like your account deleted, we can take card of this for you. Keep in mind you will
                    not be able to reactivate your account or retrieve any of the content or information you have added.
                    If you would still like your account deleted, click “Delete Account”.?') }}
                </p>
            </div>
