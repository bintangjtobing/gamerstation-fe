                    ...
                    <div class="card-body">
                        <form class="card-form">
                            ...
                            <div class="col-xl-12 col-lg-12">
                                ...
                                <button type="button" class="btn--base bg--warning w-100 active-deactive-btn">{{
                                    __('Disable') }}</button>
                                <br>
                                <div class="text--danger mt-3">
                                    {{ __("Don't forget to add this application in your google authentication app.
                                    Otherwise you can't login in your account.") }}
                                </div>
                                @else
                                <button type="button" class="btn--base w-100 active-deactive-btn">{{ __('Enable')
                                    }}</button>
                                @endif
                            </div>
                        </form>
            ...
            <div class="dash-payment-item-wrapper">
                <div class="dash-payment-item active">
                    ...
                    <div class="card-body">
                        ...
                        <p>{{ __('Google Authenticator is a product based authenticator by Google that executes
                            two-venture confirmation administrations for verifying clients of any programming
                            applications.') }}
                        </p>
                        <div class="play-store-thumb text-center mb-20">
                            <img class="mx-auto" src="{{ asset('frontend/') }}/images/element/play-store.png">
                        </div>
                        <a href="https://play.google.com/store/apps" class="btn--base mt-10 w-100">{{ __('Download App')
                            }}</a>
                    </div>
                </div>
            </div>
