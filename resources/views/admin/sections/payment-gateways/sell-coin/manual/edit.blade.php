...
@section('content')
    <form action="{{ setRoute('admin.payment.gateway.update', ['sell-coin', 'manual', $payment_gateway->alias]) }}"
                    ...
                    <div class="col-xl-9 col-lg-9">
                        ...
                        <div class="form-group">
                            @include('admin.components.form.input', [
                                ...
                                'value' => old(
                                    'currency_code',
                                    $payment_gateway->currencies->first()->currency_code),
                                'class' => 'currency_type',
                                'placeholder' => 'ex: USD',
                                'class' => 'currency_type',
                                'data_limit' => 8,
                        ...
                        <div class="form-group">
                            @include('admin.components.form.input', [
                                ...
                                'value' => old(
                                    'currency_symbol',
                                    $payment_gateway->currencies->first()->currency_symbol),
                            ])
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6">
                                        <div class="form-group">
                                            @include('admin.components.form.input-amount', [
                                                ...
                                                'value' => old(
                                                    'min_limit',
                                                    $payment_gateway->currencies->first()->min_limit),
                                    ...
                                    <div class="col-xl-6 col-lg-6">
                                        <div class="form-group">
                                            @include('admin.components.form.input-amount', [
                                                ...
                                                'value' => old(
                                                    'max_limit',
                                                    $payment_gateway->currencies->first()->max_limit),
                                                'currency' => $payment_gateway->currencies->first()->currency_code,
                                            ])
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6">
                                        <div class="form-group">
                                            @include('admin.components.form.input-amount', [
                                                ...
                                                'value' => old(
                                                    'fixed_charge',
                                                    $payment_gateway->currencies->first()->fixed_charge),
                                                'currency' => $payment_gateway->currencies->first()->currency_code,
                                            ])
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-lg-6">
                                        <div class="form-group">
                                            @include('admin.components.form.input-amount', [
                                                ...
                                                'value' => old(
                                                    'percent_charge',
                                                    $payment_gateway->currencies->first()->percent_charge),
                                                'currency' => $payment_gateway->currencies->first()->currency_code,
                                            ])
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form--control"
                                                    value="{{ old('rate', $payment_gateway->currencies->first()->rate) }}"
                                                    name="rate" placeholder="Type Here...">
                                                <span
                                                    class="input-group-text currency">{{ $payment_gateway->currencies->first()->currency_code }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    @foreach ($payment_gateway->input_fields as $item)
                                        <div class="row add-row-wrapper align-items-end">
                                            ...
                                            <div class="col-xl-2 col-lg-2 form-group">
                                                ...
                                                <select class="form--control nice-select field-input-type"
                                                    name="input_type[]" data-old="{{ $item->type }}" data-show-db="true">
                                            ...
                                            <div class="col-xl-1 col-lg-1 form-group">
                                                <button type="button"
                                                    class="custom-btn btn--base btn--danger row-cross-btn w-100 btn-loading"><i
