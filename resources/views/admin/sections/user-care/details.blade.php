                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{ get_amount($data['balance'], get_default_currency_code()) }}
                                    </h2>
                                </div>
                            </div>
                            <div class="right">
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">
                                        {{ get_amount($data['add_money_amount'], get_default_currency_code()) }}</h2>
                                </div>
                            </div>
                            <div class="right">
                                <div class="dashboard-icon">
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">
                                        {{ get_amount($data['total_transaction'], get_default_currency_code()) }}</h2>
                                </div>
                            </div>
                            <div class="right">
                                <div class="dashboard-icon">
                    ...
                    <div class="col-xl-4 col-lg-4 form-group">
                        <ul class="user-profile-list">
                            ...
                            <li class="bg--warning four">{{ __('Status') }}:
                                <span>{{ __($user->stringStatus->value) }}</span>
                            </li>
