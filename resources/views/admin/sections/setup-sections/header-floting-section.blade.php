...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#header-floting-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i>
                        {{ __('Add Floting') }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.add-header-floting-item')

    {{-- Header Floting Item Edit Modal --}}
    <div id="header-floting-edit" class="mfp-hide large">
        <div class="modal-data">
            <div class="modal-header px-0">
                <h5 class="modal-title">{{ __('Edit Header Floting') }}</h5>
            </div>
...
@push('script')
    ...
    <script>
        openModalWhenError("header-floting-add", "#header-floting-add");
        openModalWhenError("header-floting-edit", "#header-floting-edit");
        ...
        $(".edit-modal-button").click(function() {
            ...
            var editModal = $("#header-floting-edit");
            ...
            fileHolderPreviewReInit("#header-floting-edit input[name=image]");
            openModalBySelector("#header-floting-edit");
