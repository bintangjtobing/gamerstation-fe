...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#services-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i>
                        {{ __('Add Service') }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.add-services-item')

    {{-- Services Item Edit Modal --}}
    <div id="services-edit" class="mfp-hide large">
...
@push('script')
    ...
    <script>
        openModalWhenError("services-add", "#services-add");
        openModalWhenError("services-edit", "#services-edit");
        ...
        $(".edit-modal-button").click(function() {
            ...
            fileHolderPreviewReInit("#services-edit input[name=image]");
            openModalBySelector("#services-edit");
