                        ...
                        <div class="product-tab">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane @if (get_default_language_code() == language_const()::NOT_REMOVABLE) fade show active @endif"
                                    ...
                                    <div class="form-group">
                                        @include('admin.components.form.textarea', [
                                            'label' => __('Newsletter Description') . '*',
                                    ...
                                    <div class="form-group">
                                        @include('admin.components.form.textarea', [
                                            ...
                                            'name' => $default_lang_code . '_app_description',
                                            'value' => old(
                                                $default_lang_code . '_app_description',
                                                $data->value->language->$default_lang_code->app_description ?? ''),
                                        ])
                                    </div>
                                ...
                                @foreach ($languages as $item)
                                    ...
                                    <div class="tab-pane @if (get_default_language_code() == $item->code) fade show active @endif"
                                        ...
                                        <div class="form-group">
                                            @include('admin.components.form.textarea', [
                                                'label' => __('App Description') . '*',
                                                'name' => $item->code . '_app_description',
                                                'value' => old(
                                                    $item->code . '_app_description',
                                                    $data->value->language->$lang_code->app_description ?? ''),
                                            ])
                                        </div>
