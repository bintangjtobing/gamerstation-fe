...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#why-choose-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i>
                        {{ __('Add Step') }}</a>
                </div>
            </div>
                        ...
                        @forelse ($data->value->items ?? [] as $key => $item)
                            <tr data-item="{{ json_encode($item) }}">
                                ...
                                <td><a href="{{ $item->language->$system_default_lang->link ?? '' }}"
                                        class="text--danger"><i
                                            class="{{ $item->language->$system_default_lang->item_social_icon ?? '' }}"></i></a>
                                </td>
                                <td><a href="{{ $item->language->$system_default_lang->link ?? '' }}"
    ...
    @include('admin.components.modals.site-section.add-why-choose-item')

    {{-- How it's work Item Edit Modal --}}
    <div id="why-choose-edit" class="mfp-hide large">
        <div class="modal-data">
            <div class="modal-header px-0">
                <h5 class="modal-title">{{ __('Edit Why Choose') }}</h5>
            </div>
...
@push('script')
    ...
    <script>
        openModalWhenError("why-choose-add", "#why-choose-add");
        openModalWhenError("why-choose-edit", "#why-choose-edit");
        ...
        $(".edit-modal-button").click(function() {
            ...
            fileHolderPreviewReInit("#why-choose-edit input[name=image]");
            openModalBySelector("#why-choose-edit");
