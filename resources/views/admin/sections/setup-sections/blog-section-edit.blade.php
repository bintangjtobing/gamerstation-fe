                            ...
                            <select name="category_id" id="category" class="form--control nice-select" required>
                                @foreach ($categories ?? [] as $cat)
                                    <option value="{{ $cat->id }}"
                                        ...
                                        {{ $cat->data?->language?->$system_default_lang?->name ?? $cat->data?->language?->$system_default?->name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <button class="nav-link @if (get_default_language_code() == language_const()::NOT_REMOVABLE) active @endif"
                                    id="edit-modal-english-tab" data-bs-toggle="tab" data-bs-target="#edit-modal-english"
                                        ...
                                        <div class="col-xl-12">
                                            <div class="form-group">
                                                @include('admin.components.form.input', [
                                                    ...
                                                    'value' => old(
                                                        $lang_code . '_name',
                                                        $data->name->language->$lang_code->name ?? ''),
                                                ])
                                            </div>
                                        </div>
