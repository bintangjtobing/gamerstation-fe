                                ...
                                <div class="tab-pane @if (get_default_language_code() == language_const()::NOT_REMOVABLE) fade show active @endif"
                                    ...
                                    <div class="form-group">
                                        @include('admin.components.form.input', [
                                            ...
                                            'value' => old(
                                                $default_lang_code . '_footer_text',
                                                $data->value->language->$default_lang_code->footer_text ?? ''),
                                        ])
                                    </div>
                                    <div class="form-group">
                                        @include('admin.components.form.input', [
                                            ...
                                            'value' => old(
                                                $default_lang_code . '_app_text',
                                                $data->value->language->$default_lang_code->app_text ?? ''),
                                        ])
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        @include('admin.components.form.input', [
                                            ...
                                            'value' => old(
                                                $default_lang_code . '_newsltter_details',
                                                $data->value->language->$default_lang_code->newsltter_details ??
                                                    ''),
                                        ])
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-pane @if (get_default_language_code() == $item->code) fade show active @endif"
                                        ...
                                        <div class="form-group">
                                            @include('admin.components.form.input', [
                                                ...
                                                'value' => old(
                                                    $lang_code . '_app_text',
                                                    $data->value->language->$lang_code->app_text ?? ''),
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.textarea', [
                                        ...
                                        <div class="form-group">
                                            @include('admin.components.form.input', [
                                                ...
                                                'value' => old(
                                                    $lang_code . '_newsltter_details',
                                                    $data->value->language->$lang_code->newsltter_details ?? ''),
                                            ])
                                        </div>
                                    </div>
                                @endforeach
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#icon-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i>
                    ...
                    <tbody>
                        @forelse ($data->value->items ?? [] as $key => $item)
                            <tr data-item="{{ json_encode($item) }}">
                                ...
                                <td><a href="{{ $item->language->$system_default_lang->name ?? '' }}"
                                        class="text--dark">{{ $item->language->$system_default_lang->name ?? '' }}</a></td>
                                <td><a href="{{ $item->language->$system_default_lang->social_icon ?? '' }}"
                                        class="text--info"><i
                                            class="{{ $item->language->$system_default_lang->social_icon ?? '' }}"></i></a>
                                </td>
                                <td><a href="{{ $item->language->$system_default_lang->link ?? '' }}"
                                        class="text--dark">{{ $item->language->$system_default_lang->link ?? '' }}</a></td>
                                <td>
