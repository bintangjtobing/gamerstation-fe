                                ...
                                <div class="tab-pane @if (get_default_language_code() == language_const()::NOT_REMOVABLE) fade show active @endif"
                                    ...
                                    <div class="form-group">
                                        @include('admin.components.form.input', [
                                            ...
                                            'value' => old(
                                                $default_lang_code . '_designation_edit',
                                                $data->value->language->$default_lang_code->designation ?? ''),
                                        ])
                                    </div>
                                    <div class="form-group">
                                        @include('admin.components.form.input', [
                                            ...
                                            'value' => old(
                                                $default_lang_code . '_header_edit',
                                                $data->value->language->$default_lang_code->header ?? ''),
                                        ])
                                    </div>
                                    <div class="form-group">
                                        @include('admin.components.form.input', [
                                            ...
                                            'value' => old(
                                                $default_lang_code . '_rating_edit',
                                                $data->value->language->$default_lang_code->rating ?? ''),
                                        ])
                                    </div>
                                    <div class="form-group">
                                        @include('admin.components.form.textarea', [
                                    ...
                                    <div class="tab-pane @if (get_default_language_code() == $item->code) fade show active @endif"
                                        ...
                                        <div class="form-group">
                                            @include('admin.components.form.input', [
                                                ...
                                                'value' => old(
                                                    $lang_code . '_designation_edit',
                                                    $data->value->language->$lang_code->designation ?? ''),
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.input', [
                                                ...
                                                'value' => old(
                                                    $lang_code . '_header_edit',
                                                    $data->value->language->$lang_code->header ?? ''),
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.input', [
                                                ...
                                                'value' => old(
                                                    $lang_code . '_rating_edit',
                                                    $data->value->language->$lang_code->rating ?? ''),
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.textarea', [
...
@push('script')
    <script>
        ...
        $(".edit-modal-button").click(function() {
            ...
            editModal.find("input[name=" + default_language + "_name_edit]").val(oldData.language[default_language]
                .name);
            editModal.find("input[name=" + default_language + "_designation_edit]").val(oldData.language[
                default_language].designation);
            editModal.find("input[name=" + default_language + "_header_edit]").val(oldData.language[
                default_language].header);
            editModal.find("input[name=" + default_language + "_rating_edit]").val(oldData.language[
                default_language].rating);
            editModal.find("textarea[name=" + default_language + "_details_edit]").val(oldData.language[
                default_language].details);

            $.each(languages, function(index, item) {
                editModal.find("input[name=" + item.code + "_name_edit]").val(oldData.language[item.code]
                    ?.name);
                editModal.find("input[name=" + item.code + "_designation_edit]").val(oldData.language[item
                    .code]?.designation);
                editModal.find("input[name=" + item.code + "_header_edit]").val(oldData.language[item.code]
                    ?.header);
                editModal.find("input[name=" + item.code + "_rating_edit]").val(oldData.language[item.code]
                    ?.rating);
