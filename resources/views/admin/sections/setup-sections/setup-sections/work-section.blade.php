        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#work-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i>
                        {{ __('Add Item ') }}</a>
                </div>
            </div>
                                ...
                                <div class="tab-pane @if (get_default_language_code() == language_const()::NOT_REMOVABLE) fade show active @endif"
                                    ...
                                    <div class="form-group">
                                        @include('admin.components.form.input', [
                                            ...
                                            'value' => old(
                                                $default_lang_code . '_icon_edit',
                                                $data->value->language->$default_lang_code->icon ?? ''),
                                            'class' =>
                                    ...
                                    <div class="tab-pane @if (get_default_language_code() == $item->code) fade show active @endif"
                                        ...
                                        <div class="form-group">
                                            @include('admin.components.form.input', [
                                                ...
                                                'value' => old(
                                                    $lang_code . '_icon_edit',
                                                    $data->value->language->$lang_code->icon ?? ''),
                                                'class' =>
                                                    'form--control icp icp-auto iconpicker-element iconpicker-input',
                                            ])
                                        </div>
    ...
    <script>
        ...
        $(".edit-modal-button").click(function() {
            ...
            editModal.find("input[name=" + default_language + "_name_edit]").val(oldData.language[default_language]
                .name);
            editModal.find("input[name=" + default_language + "_icon_edit]").val(oldData.language[default_language]
                .icon);
            $.each(languages, function(index, item) {
                editModal.find("input[name=" + item.code + "_name_edit]").val(oldData.language[item.code]
                    ?.name);
                editModal.find("input[name=" + item.code + "_icon_edit]").val(oldData.language[item.code]
                    ?.icon);
