                                ...
                                <div class="tab-pane @if (get_default_language_code() == language_const()::NOT_REMOVABLE) fade show active @endif"
                                    ...
                                    <div class="form-group">
                                        @include('admin.components.form.input', [
                                            ...
                                            'value' => old(
                                                $default_lang_code . '_button_name',
                                                $data->value->language->$default_lang_code->button_name ?? ''),
                                        ])
                                    </div>
                                    <div class="form-group">
                                        @include('admin.components.form.input', [
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#floting-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i>
                        {{ __('Add Activities ') }}</a>
                </div>
            </div>
