                                ...
                                <div class="tab-pane @if (get_default_language_code() == language_const()::NOT_REMOVABLE) fade show active @endif"
                                    ...
                                    <div class="form-group">
                                        @include('admin.components.form.textarea', [
                                            ...
                                            'value' => old(
                                                $default_lang_code . '_sub_title_edit',
                                                $data->value->language->$default_lang_code->sub_title ?? ''),
                                        ])
                                    </div>
    ...
    <script>
        ...
        $(".edit-modal-button").click(function() {
            ...
            editModal.find("input[name=" + default_language + "_icon_edit]").val(oldData.language[default_language]
                .icon);
            editModal.find("textarea[name=" + default_language + "_sub_title_edit]").val(oldData.language[
                default_language].sub_title);
            $.each(languages, function(index, item) {
                ...
                editModal.find("input[name=" + item.code + "_icon_edit]").val(oldData.language[item.code]
                    ?.icon);
                editModal.find("textarea[name=" + item.code + "_sub_title_edit]").val(oldData.language[item
                    .code]?.sub_title);
