<div id="how-its-works-add" class="mfp-hide large">
                            ...
                            <div class="tab-pane @if (get_default_language_code() == language_const()::NOT_REMOVABLE) fade show active @endif"
                                ...
                                <div class="form-group">
                                    @include('admin.components.form.input', [
                                        ...
                                        'value' => old(
                                            $default_lang_code . '_item_social_icon',
                                ...
                                <div class="form-group">
                                    @include('admin.components.form.input', [
                                        ...
                                        'name' => $default_lang_code . '_item_step_number',
                                        'value' => old(
                                            $default_lang_code . '_item_step_number',
                                            $data->value->language->$default_lang_code->item_step_number ?? ''),
                                    ])
                                </div>
                                <div class="form-group">
                                    @include('admin.components.form.input', [
                            ...
                            @foreach ($languages as $item)
                                ...
                                <div class="tab-pane @if (get_default_language_code() == $item->code) fade show active @endif"
                                    ...
                                    <div class="form-group">
                                        @include('admin.components.form.input', [
                                            'label' => __('Step Number')."*",
                                            'name' => $lang_code . '_item_step_number',
                                            'value' => old(
                                                $lang_code . '_item_step_number',
                                                $data->value->language->$lang_code->item_step_number ?? ''),
                                        ])
                                    </div>
                                    <div class="form-group">
                                        @include('admin.components.form.input', [
