        ...
        <div class="chat-form">
            <div class="publisher">
                ...
                <div class="chatbox-send-part">
                    <button type="button" class="chat-submit-btn chat-submit-btn-event"><i
                            class="lab la-telegram-plane"></i></button>
                </div>
            </div>
        </div>
    @else
        <div class="solved-message py-3 px-4 text-warning">
            {{ __('This ticket is solved, you can not send message right now.') }}</div>
    @endif
@endisset
