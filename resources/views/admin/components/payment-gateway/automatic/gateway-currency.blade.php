@isset($gateway)
    <div class="payment-gateway-currencies-wrapper">
        @foreach ($gateway->currencies as $item)
            <div class="custom-card mt-15 gateway-currency" id="{{ Str::lower($item->currency_code) . '-block' }}"
                data-target="{{ $item->id }}">
                <div class="card-header">
                    <h6 class="currency-title">{{ __($item->name) }}</h6>
                </div>
                <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                @include('admin.components.form.input-amount', [
                                                    ...
                                                    'name' =>
                                                        ...
                                                        '][min_limit]',
                                                    'value' => old(
                                                        'gateway_currency.' . $item->currency_code . '.min_limit',
                                                        $item->min_limit),
                                            ...
                                            <div class="form-group">
                                                @include('admin.components.form.input-amount', [
                                                    ...
                                                    'name' =>
                                                        ...
                                                        '][max_limit]',
                                                    'value' => old(
                                                        'gateway_currency.' . $item->currency_code . '.max_limit',
                                                        $item->max_limit),
                                                    'currency' => $item->currency_code,
                                                ])
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form--control"
                                                        value="{{ old('gateway_currency.' . $item->currency_code . '.rate', $item->rate) }}"
                                                        name="{{ 'gateway_currency[' . $item->currency_code . '][rate]' }}">
